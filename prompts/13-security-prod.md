...
## Objetivo
Dejar Waseller **deployable a una VPS** con seguridad mínima profesional: TLS,
...
- `infra/systemd/waseller.service` — systemd unit para arranque en boot.
- Cifrado AES-256 de tokens sensibles (`sdk/waseller/security/crypto.py`).
