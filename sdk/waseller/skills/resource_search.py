...
from waseller.resources.models import QueryLogEntry
...
class ResourceSearchSkill(SkillBase):
    ...
    def __init__(
        ...
        *,
        ...
        # WasellerClient injects the same backing repositories the API uses,
    ...
    async def execute(self, context: dict[str, Any], params: dict[str, Any]) -> SkillResult:
        ...
        logging.getLogger("waseller.skills.resource_search").debug(
