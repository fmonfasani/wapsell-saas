...
- :class:`PostgresBuyerMemory` — PEP 249 connection + ``buyer_interactions``
  ...
  Production default once ``WAPSELL_POSTGRES_URL`` is set; survives container
...
class PostgresBuyerMemory:
    ...
    this in main.py (via ``WAPSELL_POSTGRES_URL``) closes the last in-process
