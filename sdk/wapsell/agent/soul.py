...
from wapsell.models import SoulConfig, Tenant

# Re-export so existing callers (`from wapsell.agent.soul import SoulConfig`)
...
class SoulBuilder:
    ...
    def build(
        ...
        *,
        ...
        produced by :class:`wapsell.resources.LearningService` — fields
