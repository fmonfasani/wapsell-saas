...
from wapsell.resources.models import DataSource
from wapsell.resources.repository import DataSourceRepositoryPort

if TYPE_CHECKING:
    from wapsell.resources.sync import ResourceSynchronizer

_log = logging.getLogger("wapsell.resources.scheduler")
