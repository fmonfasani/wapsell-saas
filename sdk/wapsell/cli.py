"""wapsell CLI (argparse — dependency-free).

wapsell tenant-create --name "Acme" --slug acme
wapsell soul --name "Acme" --slug acme
wapsell skills list
wapsell goal --type qualify --message "quiero comprar zapatillas"
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="wapsell", description="Wapsell control CLI")
